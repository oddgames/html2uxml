...
It is based on Unity 6.4 UI Toolkit documentation plus the 2022.3 custom
...
|---------|--------------------|-------------|
| `box-shadow`, `drop-shadow`, CSS gradients, polygon clips, linear mask fades | Automatic `odd:Html2UxmlPanel` promotion | Install package |
...
Use native USS first when Unity has the property. Unity 6.4 covers more than
...
Unity 6.4 filters render an element subtree to a texture, process it, and
...
The converter can emit native filter functions directly. For custom filters,
the package should ship Unity filter assets/materials and map source CSS to a
known USS filter call or package class.
...
Use a new element or custom filter for effects that require subtree pixels or
scene pixels.
...
- USS custom properties:
  https://docs.unity3d.com/6000.4/Documentation/Manual/UIE-USS-CustomProperties.html
- Generate 2D visual content:
  https://docs.unity3d.com/6000.4/Documentation/Manual/UIE-generate-2d-visual-content.html
...
- Text effects:
  https://docs.unity3d.com/6000.4/Documentation/Manual/UIE-text-effects.html
- Work with text:
  https://docs.unity3d.com/6000.4/Documentation/Manual/UIE-work-with-text.html
- USS filters:
  https://docs.unity3d.com/6000.4/Documentation/Manual/ui-systems/uss-filter.html
- Built-in filters:
  https://docs.unity3d.com/6000.4/Documentation/Manual/ui-systems/built-in-filters.html
